        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceivedMonth = table.Column<int>(type: "int", nullable: true),
                    ReceivedYear = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Awards_Candidates_CandidateId",
            ...
            migrationBuilder.CreateTable(
                name: "CandidateRecruitments",
                columns: table => new
                {
                    CandidateRecruitmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecruitmentId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateRecruitments", x => x.CandidateRecruitmentId);
                    table.ForeignKey(
                        name: "FK_CandidateRecruitments_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "CandidateId");
                    table.ForeignKey(
                        name: "FK_CandidateRecruitments_Recruitments_RecruitmentId",
            ...
            migrationBuilder.CreateTable(
                name: "SaveRecruitments",
                columns: table => new
                {
                    SaveRecruitmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecruitmentId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CandidateId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaveRecruitments", x => x.SaveRecruitmentId);
                    table.ForeignKey(
                        name: "FK_SaveRecruitments_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "CandidateId");
                    table.ForeignKey(
                        name: "FK_SaveRecruitments_Recruitments_RecruitmentId",
                        column: x => x.RecruitmentId,
                        principalTable: "Recruitments",
                        principalColumn: "RecruitmentId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Awards_CandidateId",
                table: "Awards",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateRecruitments_CandidateId",
                table: "CandidateRecruitments",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateRecruitments_RecruitmentId",
                table: "CandidateRecruitments",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "SaveRecruitments",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_SaveRecruitments_RecruitmentId",
                table: "SaveRecruitments",
                column: "RecruitmentId");
